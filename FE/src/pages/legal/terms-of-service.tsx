                        ...
                        <div className="prose prose-indigo max-w-none">
                            ...
                            <section className="mb-8">
                                ...
                                <p className="text-gray-600 mb-4">
                                    By accessing or using DigiPiggy (“the Service”), you agree to be bound by these Terms and Conditions and our Privacy Policy. If you do not agree, please do not use the Service.
                                </p>
                            </section>
                            ...
                            <section className="mb-8">
                                ...
                                <p className="text-gray-600 mb-4">
                                    Permission is granted to temporarily access the materials (information or software) on DigiPiggy Kids's
                                ...
                                <ul className="list-disc pl-6 text-gray-600 mb-4">
                                    ...
                                    <li>Attempt to decompile or reverse engineer any software contained on DigiPiggy's website</li>
                            ...
                            <section className="mb-8">
                                ...
                                <p className="text-gray-600 mb-4">
                                    The materials on DigiPiggy's website are provided on an 'as is' basis. DigiPiggy makes no
                            ...
                            <section className="mb-8">
                                ...
                                <p className="text-gray-600 mb-4">
                                    In no event shall DigiPiggy or its suppliers be liable for any damages (including, without
                                    limitation, damages for loss of data or profit, or due to business interruption) arising out of
                                    the use or inability to use the materials on DigiPiggy's website.
                                </p>
                            </section>
                            <section className="mb-8">
